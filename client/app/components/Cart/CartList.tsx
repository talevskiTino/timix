...
const CartList = (props: any) => {
  ...
  const cartItems = props?.cartDataProps?.userCartItems;
  useEffect(() => {
      ...
      <div className="flex flex-col shadow-md my-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-between mt-10 mb-5">
            <span className="font-semibold text-sm uppercase mb-2 sm:mb-0">
          ...
          <div className="border-t mt-8">
            <div className="flex flex-col sm:flex-row font-semibold justify-between py-6 text-sm uppercase">
